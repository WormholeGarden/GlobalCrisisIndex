...
//  GET /api/top-story?iso=SOM          → one country by ISO
//  GET /api/top-story?iso=SOM,YEM      → comparison payload
//  GET /api/top-story?top=5            → top N countries (max 50)
//  GET /api/top-story?q=somalia        → fuzzy name search
//  GET /api/top-story?region=africa    → all countries in region, ranked
//  GET /api/top-story?threshold=90     → all countries at or above score
...
const CFG = {
  ...
  PRIOR_JITTER:        4,
  PRIOR_CAP:           85,
  ANOMALY_WINDOW:      28,      // days of history for baseline
  ANOMALY_Z_THRESHOLD: 2.0,     // z-score threshold for flagging
  CUSUM_K:             0.5,     // CUSUM allowance (in std devs)
  CUSUM_H:             4.0,     // CUSUM decision threshold
  CHANGEPOINT_MIN_SEG: 5,       // minimum segment length for changepoint
};
...
const COUNTRIES = {
  ...
  LBN:{ name:"Lebanon",              flag:"🇱🇧", prior:47, region:"middleeast", types:["CE","REF","EP","HEAT"],          adj:["SYR","ISR"],                                                  cent:[35.5,33.9]  },
  ...
  LKA:{ name:"Sri Lanka",            flag:"🇱🇰", prior:34, region:"asia",       types:["FL","TC","DR","EP","HEAT"],      adj:["IND"],                                                         cent:[80.7,7.9]   },
  ...
  PRK:{ name:"North Korea",          flag:"🇰🇵", prior:52, region:"asia",       types:["DR","FL","HEAT","ST"],           adj:["CHN","RUS","KOR"],                                            cent:[127.5,40.3] },
  TWN:{ name:"Taiwan",               flag:"🇹🇼", prior:24, region:"asia",       types:["TC","EQ","TSU","FL","HEAT"],     adj:[],                                                               cent:[120.9,23.7] },
  HKG:{ name:"Hong Kong",            flag:"🇭🇰", prior:12, region:"asia",       types:["TC","FL","HEAT"],               adj:[],                                                               cent:[114.2,22.3] },
  MAC:{ name:"Macau",                flag:"🇲🇴", prior:10, region:"asia",       types:["TC","FL","HEAT"],               adj:[],                                                               cent:[113.5,22.2] },
  ...
  SGP:{ name:"Singapore",            flag:"🇸🇬", prior:9,  region:"asia",       types:["HEAT","FL"],                    adj:[],                                                               cent:[103.8,1.4]  },
  ...
  BRN:{ name:"Brunei",               flag:"🇧🇳", prior:10, region:"asia",       types:["FL","HEAT"],                    adj:["MYS"],                                                          cent:[114.7,4.5]  },
  ...
  COM:{ name:"Comoros",              flag:"🇰🇲", prior:30, region:"africa",     types:["TC","FL","EP","HEAT"],           adj:[],                                                               cent:[43.9,-11.6] },
  MUS:{ name:"Mauritius",            flag:"🇲🇺", prior:12, region:"africa",     types:["TC","FL","HEAT"],               adj:[],                                                               cent:[57.6,-20.3] },
  SYC:{ name:"Seychelles",           flag:"🇸🇨", prior:10, region:"africa",     types:["TC","FL","HEAT"],               adj:[],                                                               cent:[55.5,-4.6]  },
  ...
  NER:{ name:"Niger",                flag:"🇳🇪", prior:56, region:"africa",     types:["DR","FN","CE","HEAT","FL"],      adj:["DZA","TCD","NGA","MLI","BFA"],                               cent:[8.1,17.6]   },
  ...
  GMB:{ name:"Gambia",               flag:"🇬🇲", prior:28, region:"africa",     types:["DR","HEAT","FL"],               adj:["SEN"],                                                          cent:[-15.3,13.4] },
  ...
  CPV:{ name:"Cape Verde",           flag:"🇨🇻", prior:12, region:"africa",     types:["DR","HEAT","ST"],               adj:[],                                                               cent:[-24.0,16.0] },
  ...
  GAB:{ name:"Gabon",                flag:"🇬🇦", prior:22, region:"africa",     types:["FL","EP","HEAT"],               adj:["CMR","COG","GNQ"],                                            cent:[11.6,-0.8]  },
  GNQ:{ name:"Equatorial Guinea",    flag:"🇬🇶", prior:26, region:"africa",     types:["FL","EP","HEAT"],               adj:["CMR","GAB"],                                                   cent:[10.3,1.7]   },
  STP:{ name:"São Tomé and Príncipe",flag:"🇸🇹", prior:14, region:"africa",     types:["FL","EP","HEAT"],               adj:[],                                                               cent:[6.6,0.2]    },
  ...
  TUN:{ name:"Tunisia",              flag:"🇹🇳", prior:30, region:"africa",     types:["DR","HEAT","FL"],               adj:["DZA","LBY"],                                                   cent:[9.5,33.9]   },
  ESH:{ name:"Western Sahara",       flag:"🇪🇭", prior:28, region:"africa",     types:["DR","HEAT","CE"],               adj:["MAR","DZA","MRT"],                                            cent:[-13.0,24.2] },
  UKR:{ name:"Ukraine",              flag:"🇺🇦", prior:52, region:"europe",     types:["CE","CW","REF","HEAT"],          adj:["RUS","POL","HUN","ROU","SVK","BLR","MDA"],                   cent:[31.2,49.0]  },
  RUS:{ name:"Russia",               flag:"🇷🇺", prior:34, region:"europe",     types:["WF","FL","CW","ST","HEAT"],      adj:["UKR","CHN","KAZ","BLR","FIN","NOR","EST","LVA","LTU","POL"],cent:[97.7,56.8]  },
  ...
  IRL:{ name:"Ireland",              flag:"🇮🇪", prior:12, region:"europe",     types:["ST","FL","HEAT"],               adj:[],                                                               cent:[-8.2,53.2]  },
  NLD:{ name:"Netherlands",          flag:"🇳🇱", prior:10, region:"europe",     types:["FL","ST","HEAT"],               adj:["DEU","BEL"],                                                   cent:[5.3,52.1]   },
  BEL:{ name:"Belgium",              flag:"🇧🇪", prior:9,  region:"europe",     types:["FL","ST","HEAT"],               adj:["FRA","NLD","DEU","LUX"],                                     cent:[4.5,50.5]   },
  CHE:{ name:"Switzerland",          flag:"🇨🇭", prior:8,  region:"europe",     types:["FL","LS","ST","HEAT"],           adj:["DEU","FRA","ITA","AUT","LIE"],                               cent:[8.2,46.8]   },
  AUT:{ name:"Austria",              flag:"🇦🇹", prior:9,  region:"europe",     types:["FL","LS","ST","HEAT"],           adj:["DEU","CHE","ITA","SVN","HUN","SVK","CZE"],                   cent:[13.2,47.6]  },
  POL:{ name:"Poland",               flag:"🇵🇱", prior:16, region:"europe",     types:["FL","ST","WF","HEAT"],           adj:["DEU","CZE","SVK","UKR","BLR","RUS","LTU"],                   cent:[19.1,51.9]  },
  CZE:{ name:"Czechia",              flag:"🇨🇿", prior:12, region:"europe",     types:["FL","ST","WF","HEAT"],           adj:["DEU","AUT","SVK","POL"],                                     cent:[15.5,49.8]  },
  SVK:{ name:"Slovakia",             flag:"🇸🇰", prior:12, region:"europe",     types:["FL","ST","WF","HEAT"],           adj:["CZE","POL","UKR","HUN","AUT"],                               cent:[19.5,48.7]  },
  HUN:{ name:"Hungary",              flag:"🇭🇺", prior:15, region:"europe",     types:["FL","ST","HEAT","WF"],           adj:["AUT","SVK","UKR","ROU","SRB","HRV","SVN"],                   cent:[19.5,47.2]  },
  SWE:{ name:"Sweden",               flag:"🇸🇪", prior:12, region:"europe",     types:["FL","ST","WF","HEAT"],           adj:["NOR","FIN","DNK"],                                            cent:[15.5,60.1]  },
  NOR:{ name:"Norway",               flag:"🇳🇴", prior:11, region:"europe",     types:["FL","ST","WF","HEAT"],           adj:["SWE","FIN","RUS"],                                            cent:[10.5,59.9]  },
  FIN:{ name:"Finland",              flag:"🇫🇮", prior:10, region:"europe",     types:["FL","ST","WF","HEAT"],           adj:["SWE","NOR","RUS"],                                            cent:[26.1,62.0]  },
  DNK:{ name:"Denmark",              flag:"🇩🇰", prior:9,  region:"europe",     types:["ST","FL","HEAT"],               adj:["DEU","SWE"],                                                   cent:[9.6,55.7]   },
  ISL:{ name:"Iceland",              flag:"🇮🇸", prior:14, region:"europe",     types:["VLC","FL","ST","HEAT"],          adj:[],                                                               cent:[-18.5,64.9] },
  BLR:{ name:"Belarus",              flag:"🇧🇾", prior:42, region:"europe",     types:["FL","ST","WF","HEAT"],           adj:["RUS","UKR","POL","LTU","LVA"],                               cent:[28.0,53.5]  },
  ...
  HRV:{ name:"Croatia",              flag:"🇭🇷", prior:16, region:"europe",     types:["EQ","FL","ST","HEAT"],           adj:["SVN","HUN","SRB","BIH","MNE"],                               cent:[15.2,45.1]  },
  BIH:{ name:"Bosnia and Herzegovina",flag:"🇧🇦",prior:30, region:"europe",     types:["FL","LS","ST","HEAT"],           adj:["HRV","SRB","MNE"],                                            cent:[17.7,44.2]  },
  MNE:{ name:"Montenegro",           flag:"🇲🇪", prior:20, region:"europe",     types:["EQ","FL","WF","HEAT"],           adj:["HRV","BIH","SRB","ALB","XKX"],                               cent:[19.3,42.8]  },
  ...
  SVN:{ name:"Slovenia",             flag:"🇸🇮", prior:10, region:"europe",     types:["EQ","FL","LS","HEAT"],           adj:["ITA","AUT","HUN","HRV"],                                     cent:[14.8,46.1]  },
  EST:{ name:"Estonia",              flag:"🇪🇪", prior:12, region:"europe",     types:["ST","FL","HEAT"],               adj:["RUS","LVA"],                                                   cent:[25.0,58.6]  },
  LVA:{ name:"Latvia",               flag:"🇱🇻", prior:12, region:"europe",     types:["ST","FL","HEAT"],               adj:["RUS","EST","BLR","LTU"],                                     cent:[24.9,56.9]  },
  LTU:{ name:"Lithuania",            flag:"🇱🇹", prior:12, region:"europe",     types:["ST","FL","HEAT"],               adj:["RUS","LVA","BLR","POL"],                                     cent:[23.9,55.9]  },
  LUX:{ name:"Luxembourg",           flag:"🇱🇺", prior:6,  region:"europe",     types:["FL","ST","HEAT"],               adj:["FRA","DEU","BEL"],                                            cent:[6.1,49.8]   },
  LIE:{ name:"Liechtenstein",        flag:"🇱🇮", prior:6,  region:"europe",     types:["FL","LS","HEAT"],               adj:["CHE","AUT"],                                                   cent:[9.5,47.2]   },
  MLT:{ name:"Malta",                flag:"🇲🇹", prior:10, region:"europe",     types:["DR","HEAT","ST"],               adj:[],                                                               cent:[14.4,35.9]  },
  AND:{ name:"Andorra",              flag:"🇦🇩", prior:6,  region:"europe",     types:["LS","HEAT"],                    adj:["ESP","FRA"],                                                   cent:[1.6,42.5]   },
  SMR:{ name:"San Marino",           flag:"🇸🇲", prior:6,  region:"europe",     types:["HEAT","FL"],                    adj:["ITA"],                                                          cent:[12.4,43.9]  },
  GRL:{ name:"Greenland",            flag:"🇬🇱", prior:10, region:"europe",     types:["ST","FL","HEAT"],               adj:[],                                                               cent:[-42.0,72.0] },
  ...
  BLZ:{ name:"Belize",               flag:"🇧🇿", prior:28, region:"americas",   types:["TC","FL","ST","HEAT"],           adj:["MEX","GTM"],                                                   cent:[-88.5,17.2] },
  ...
  CRI:{ name:"Costa Rica",           flag:"🇨🇷", prior:16, region:"americas",   types:["EQ","FL","LS","TC","HEAT"],      adj:["NIC","PAN"],                                                   cent:[-84.0,9.9]  },
  PAN:{ name:"Panama",               flag:"🇵🇦", prior:24, region:"americas",   types:["FL","LS","ST","HEAT"],           adj:["CRI","COL"],                                                   cent:[-80.0,8.6]  },
  HTI:{ name:"Haiti",                flag:"🇭🇹", prior:58, region:"americas",   types:["CE","EQ","EP","ST","REF"],       adj:["DOM"],                                                         cent:[-72.3,18.9] },
  DOM:{ name:"Dominican Republic",   flag:"🇩🇴", prior:34, region:"americas",   types:["TC","FL","EQ","ST","HEAT"],      adj:["HTI"],                                                         cent:[-70.2,18.7] },
  CUB:{ name:"Cuba",                 flag:"🇨🇺", prior:38, region:"americas",   types:["TC","FL","ST","HEAT"],           adj:["HTI"],                                                         cent:[-79.5,21.5] },
  JAM:{ name:"Jamaica",              flag:"🇯🇲", prior:32, region:"americas",   types:["TC","FL","ST","HEAT"],           adj:[],                                                               cent:[-77.3,18.1] },
  ATG:{ name:"Antigua and Barbuda",  flag:"🇦🇬", prior:12, region:"americas",   types:["TC","ST","HEAT"],               adj:[],                                                               cent:[-61.8,17.1] },
  BHS:{ name:"Bahamas",              flag:"🇧🇸", prior:16, region:"americas",   types:["TC","ST","FL","HEAT"],           adj:[],                                                               cent:[-77.4,25.0] },
  BRB:{ name:"Barbados",             flag:"🇧🇧", prior:10, region:"americas",   types:["TC","ST","HEAT"],               adj:[],                                                               cent:[-59.6,13.2] },
  DMA:{ name:"Dominica",             flag:"🇩🇲", prior:16, region:"americas",   types:["TC","VLC","ST","HEAT"],          adj:[],                                                               cent:[-61.4,15.4] },
  GRD:{ name:"Grenada",              flag:"🇬🇩", prior:12, region:"americas",   types:["TC","ST","HEAT"],               adj:[],                                                               cent:[-61.7,12.1] },
  KNA:{ name:"Saint Kitts and Nevis",flag:"🇰🇳", prior:10, region:"americas",   types:["TC","VLC","ST","HEAT"],          adj:[],                                                               cent:[-62.7,17.3] },
  LCA:{ name:"Saint Lucia",          flag:"🇱🇨", prior:12, region:"americas",   types:["TC","VLC","ST","HEAT"],          adj:[],                                                               cent:[-60.9,13.9] },
  VCT:{ name:"Saint Vincent",        flag:"🇻🇨", prior:14, region:"americas",   types:["TC","VLC","FL","HEAT"],          adj:[],                                                               cent:[-61.2,13.3] },
  TTO:{ name:"Trinidad and Tobago",  flag:"🇹🇹", prior:26, region:"americas",   types:["FL","ST","HEAT"],               adj:[],                                                               cent:[-61.2,10.7] },
  COL:{ name:"Colombia",             flag:"🇨🇴", prior:43, region:"americas",   types:["CE","CW","FL","REF","LS"],       adj:["VEN","PER","ECU","PAN","BRA"],                               cent:[-74.3,4.6]  },
  VEN:{ name:"Venezuela",            flag:"🇻🇪", prior:44, region:"americas",   types:["CE","REF","DR","HEAT"],          adj:["COL","BRA","GUY"],                                            cent:[-66.6,8.0]  },
  ...
  PRY:{ name:"Paraguay",             flag:"🇵🇾", prior:30, region:"americas",   types:["FL","DR","HEAT"],               adj:["BOL","BRA","ARG"],                                            cent:[-58.4,-23.4]},
  URY:{ name:"Uruguay",              flag:"🇺🇾", prior:14, region:"americas",   types:["FL","DR","ST","HEAT"],           adj:["BRA","ARG"],                                                   cent:[-56.0,-33.0]},
  GUY:{ name:"Guyana",               flag:"🇬🇾", prior:28, region:"americas",   types:["FL","ST","HEAT"],               adj:["VEN","BRA","SUR"],                                            cent:[-59.0,4.9]  },
  SUR:{ name:"Suriname",             flag:"🇸🇷", prior:24, region:"americas",   types:["FL","ST","HEAT"],               adj:["GUY","BRA"],                                                   cent:[-56.0,4.0]  },
  ...
  TON:{ name:"Tonga",                flag:"🇹🇴", prior:22, region:"oceania",    types:["TC","TSU","FL","HEAT"],          adj:[],                                                               cent:[-175.2,-21.2]},
  WSM:{ name:"Samoa",                flag:"🇼🇸", prior:20, region:"oceania",    types:["TC","TSU","FL","HEAT"],          adj:[],                                                               cent:[-172.1,-13.8]},
  KIR:{ name:"Kiribati",             flag:"🇰🇮", prior:32, region:"oceania",    types:["TC","FL","HEAT"],               adj:[],                                                               cent:[-157.4,1.9] },
  FSM:{ name:"Micronesia",           flag:"🇫🇲", prior:24, region:"oceania",    types:["TC","TSU","FL","HEAT"],          adj:[],                                                               cent:[158.2,6.9]  },
  MHL:{ name:"Marshall Islands",     flag:"🇲🇭", prior:28, region:"oceania",    types:["TC","TSU","FL","HEAT"],          adj:[],                                                               cent:[171.2,7.1]  },
  PLW:{ name:"Palau",                flag:"🇵🇼", prior:16, region:"oceania",    types:["TC","TSU","FL","HEAT"],          adj:[],                                                               cent:[134.5,7.5]  },
  NRU:{ name:"Nauru",                flag:"🇳🇷", prior:18, region:"oceania",    types:["TC","FL","HEAT"],               adj:[],                                                               cent:[166.9,-0.5] },
  TUV:{ name:"Tuvalu",               flag:"🇹🇻", prior:30, region:"oceania",    types:["TC","FL","HEAT"],               adj:[],                                                               cent:[179.2,-8.5] },
  COK:{ name:"Cook Islands",         flag:"🇨🇰", prior:16, region:"oceania",    types:["TC","FL","HEAT"],               adj:[],                                                               cent:[-159.8,-21.2]},
};
...
//
// Four independent methods run in parallel. A country is flagged as anomalous
// when 2+ methods agree. This reduces false positives while catching genuine
// escalations from different signal types.

/**
 * Method 1: CUSUM (cumulative sum control chart)
 * Detects persistent shifts in mean — good for gradual escalation.
 */
function detectCUSUM(arr) {
  ...
  const k    = CFG.CUSUM_K * sd;
  const h    = CFG.CUSUM_H * sd;
...
/**
 * Method 2: Z-score on recent window vs baseline
 * Detects sharp single-period spikes.
 */
function detectZScore(arr) {
  ...
  return {
    detected:  Math.abs(z) >= CFG.ANOMALY_Z_THRESHOLD,
    type:      "zscore",
    stat:      +Math.abs(z).toFixed(2),
    direction: z > 0 ? "up" : "down",
  };
}

/**
 * Method 3: Bayesian online changepoint detection (simplified BOCPD)
 * Detects structural breaks in the series — good for sudden regime changes.
 */
function detectChangepoint(arr) {
  if (arr.length < CFG.CHANGEPOINT_MIN_SEG * 2) return { detected: false, type: "changepoint", stat: 0 };
  const n   = arr.length;
  const mid = Math.floor(n / 2);
  const segA = arr.slice(0, mid);
  const segB = arr.slice(mid);
  const muA  = mean(segA), sdA = stddev(segA);
  const muB  = mean(segB), sdB = stddev(segB);
  // KL divergence between two Gaussians (asymmetric, simplified)
  const kl = Math.log(sdB / sdA) + (sdA ** 2 + (muA - muB) ** 2) / (2 * sdB ** 2) - 0.5;
  return {
    detected:  kl > 1.5,
    type:      "changepoint",
    stat:      +kl.toFixed(3),
    direction: muB > muA ? "up" : "down",
  };
}

/**
 * Method 4: Volatility regime detection
 * Flags countries whose score variance has increased — "instability surge".
 */
function detectVolatilityRegime(arr) {
  if (arr.length < 8) return { detected: false, type: "volatility", stat: 0 };
  const half    = Math.floor(arr.length / 2);
  const earlySD = stddev(arr.slice(0, half));
  const lateSD  = stddev(arr.slice(half));
  const ratio   = lateSD / earlySD;
  return {
    detected:  ratio > 2.0,
    type:      "volatility",
...
/**
 * Master anomaly runner — returns a rich anomaly object.
 * Consensus: 2+ methods firing = confirmed anomaly.
 */
function runAnomalyDetection(arr) {
  const methods = [
    detectCUSUM(arr),
    detectZScore(arr),
    detectChangepoint(arr),
    detectVolatilityRegime(arr),
  ];
  ...
  return {
    ...
    note: consensus
      ...
      : fired.length === 1
      ? `Weak signal (1/4 methods): ${fired[0].type}`
      : "No anomaly detected",
  };
}
...
function applyLiveAdjustments(priorDims, signals) {
  ...
  if (signals.ipcPhase >= 2) {
    ...
    audit.push({
      source: "IPC", field: "food", delta: boost,
  ...
  if (signals.whoOutbreaks.length > 0) {
    ...
    const total = signals.whoOutbreaks.reduce((s, ob) => s + (SEV[ob.severity] || 3), 0);
    const boost = Math.min(30, total);
    dims.health = clamp(dims.health + boost);
    audit.push({
      source: "WHO", field: "health", delta: boost,
      reason: `Active outbreaks: ${signals.whoOutbreaks.map(o => `${o.disease} (${o.severity})`).join(", ")}`,
  ...
  if (signals.quakeMag >= 4.5) {
    ...
    audit.push({
      source: "USGS", field: "displacement+health", delta: boost,
  ...
  if (signals.totalDisplaced > 0) {
    ...
    if (boost > 0) {
      ...
      audit.push({
        source: "UNHCR", field: "displacement", delta: boost,
  ...
  if (signals.maxTempC >= 35) {
    ...
    dims.health  = clamp(dims.health  + Math.floor(boost * 0.4));
    audit.push({
      source: "Open-Meteo", field: "climate+health", delta: boost,
...
function extractSignals(iso, live) {
  ...
  // Sum all population across phases for this country
...
function recommendation(score, anomaly) {
  const anomalyNote = anomaly?.detected ? ` Statistical anomaly detected (${anomaly.severity}).` : "";
  if (score >= 85) return { tier:"IMMEDIATE", text:`Immediate humanitarian response required. All agencies mobilise.${anomalyNote}` };
  if (score >= 75) return { tier:"URGENT",    text:`Urgent response needed. Mobilise resources now.${anomalyNote}` };
  if (score >= 60) return { tier:"HIGH",      text:`Elevated concern. Prepare response and monitor daily.${anomalyNote}` };
  if (score >= 40) return { tier:"MONITOR",   text:`Monitor situation. Maintain readiness.${anomalyNote}` };
  return                 { tier:"WATCH",      text:`Routine monitoring. No immediate action required.${anomalyNote}` };
}
...
function buildNarrative(iso, store, ranked) {
  ...
  const topDims = [...DIMS].map(d => ({ ...d, val: c.dims[d.k] || 0 })).sort((a, b) => b.val - a.val).slice(0, 3);
  const delta   = hist[hist.length - 1] - hist[Math.max(0, hist.length - 8)];
  const dAbs    = Math.abs(Math.round(delta));

  const trendPhrase =
    delta > 5  ? `Escalating rapidly (+${dAbs} pts over 7 days)` :
    delta > 2  ? `Escalating (+${dAbs} pts)` :
    delta < -5 ? `Improving significantly (−${dAbs} pts)` :
    delta < -2 ? `Improving (−${dAbs} pts)` :
                 `Stable (±${dAbs} pts)`;

  const evidence = [];
  if (s.quakeMag >= 4.5)
    evidence.push(`🌍 M${s.quakeMag.toFixed(1)} earthquake — ${s.quakePlace}${s.quakeCount > 1 ? ` (${s.quakeCount} events this week)` : ""} · USGS`);
  if (s.ipcPhase >= 4)
    evidence.push(`🍚 IPC Phase ${s.ipcPhase} (Emergency) — ${fmtPop(s.ipcPopulation)} people · IPC Global`);
  else if (s.ipcPhase === 3)
    evidence.push(`🌾 IPC Phase 3 (Crisis) — ${fmtPop(s.ipcPopulation)} people in acute food insecurity · IPC Global`);
  else if (s.ipcPhase === 2)
    evidence.push(`🌾 IPC Phase 2 (Stressed) food situation · IPC Global`);
  for (const ob of (s.whoOutbreaks || []).slice(0, 2))
    evidence.push(`🦠 ${ob.disease} outbreak — ${ob.severity}${ob.cases ? ` (${ob.cases.toLocaleString()} cases)` : ""} · WHO`);
  if (s.totalDisplaced > 0) {
    ...
    evidence.push(`🚶 ${fmtPop(s.totalDisplaced)} displaced total${parts.length ? ` (${parts.join(", ")})` : ""} · UNHCR`);
  }
  ...
  const parts = [];
  parts.push(`${c.flag} **${c.name}** — Urgency score **${c.score}/100** (${sev})`);
  parts.push(`Ranks **#${rank}** of ${ranked.length} tracked countries (top ${pct}%).`);

  parts.push(`\n**Score drivers:**`);
  for (const d of topDims) {
    let ctx = "";
    if (d.k === "displacement" && s.totalDisplaced > 0) ctx = ` — ${fmtPop(s.totalDisplaced)} people displaced`;
    if (d.k === "food" && s.ipcPhase >= 3) ctx = ` — IPC Phase ${s.ipcPhase}, ${fmtPop(s.ipcPopulation)} affected`;
    if (d.k === "health" && s.whoOutbreaks?.length) ctx = ` — ${s.whoOutbreaks[0].disease} outbreak active`;
    parts.push(`• ${d.l}: **${d.val}/100**${ctx}`);
  }

  parts.push(`\n**Trend:** ${trendPhrase}`);
  parts.push(`**7-day forecast:** ${fc.fc}/100 (${fc.trend})`);

  if (evidence.length) {
    parts.push(`\n**Live evidence (sourced):**`);
    evidence.forEach(e => parts.push(`• ${e}`));
  }

  if (anom.detected) {
    parts.push(`\n**⚠️ Anomaly detected** — ${anom.note}`);
    parts.push(`Methods triggered: ${anom.methods.filter(m => m.detected).map(m => m.type).join(", ")}`);
  }

  if (hotNb.length)
    parts.push(`\n🌐 Regional spillover from ${hotNb.slice(0, 2).join(" and ")} adds +${c.spillover.toFixed(1)} pts.`);

  if (c.liveBoost !== 0)
    parts.push(`\n📊 Live data adjusted score ${c.liveBoost > 0 ? `+${c.liveBoost}` : c.liveBoost} pts from prior estimate of ${c.priorScore}/100.`);

  parts.push(`\n**Recommendation:** ${recommendation(c.score, anom).text}`);
...
function buildComparison(isos, store, ranked) {
  ...
  const verdict = rows.length === 2
    ? `${sorted[0].flag} ${sorted[0].name} is more severe (${sorted[0].score} vs ${sorted[1].score}). Key difference: ${differentiators[0] ? `${sorted[0].name} scores higher on ${differentiators[0].dimension}` : "broadly similar profiles"}.`
...
function buildPayload(iso, store, ranked) {
  ...
  return {
    ...
    live_evidence: {
      earthquake: s.quakeMag >= 4.5
        ? { magnitude: s.quakeMag, location: s.quakePlace, event_count: s.quakeCount, source: "USGS" }
        : null,
      food_security: s.ipcPhase >= 1
        ? { phase: s.ipcPhase, population_affected: s.ipcPopulation, total_population_in_crisis: s.ipcTotalPop, source: "IPC Global" }
        : null,
      disease_outbreaks: (s.whoOutbreaks || []).map(o => ({ ...o, source: "WHO" })),
      displacement: s.totalDisplaced > 0
        ? { total: s.totalDisplaced, refugees: s.refugees, idps: s.idps, asylum_seekers: s.asylum_seekers, source: "UNHCR" }
        : null,
      heat: s.maxTempC >= 35
        ? { max_temp_c: s.maxTempC, source: "Open-Meteo" }
        : null,
    },
...
export default async function handler(req, res) {
  ...
  if (params.q && !params.iso) {
    ...
    if (!resolved) {
      ...
      res.end(JSON.stringify({
        ...
        hint:      "Try ISO-3166-1 alpha-3 (e.g. SOM, YEM) or full country name",
  ...
  try {
    ...
    // Summary anomaly counts across all tracked countries
    const allAnomalies = Object.keys(store).filter(iso => {
      const hist = seedHistory(iso, store[iso].score);
      return runAnomalyDetection(hist).detected;
    });
    ...
    const body = {
      meta: {
        ...
        sources,
        anomaly_methodology: "4-method ensemble: CUSUM (persistent shift), Z-score (spike), Bayesian changepoint (structural break), Volatility regime (instability surge). Consensus threshold: 2/4 methods.",
        score_methodology:   "Weighted 8-dimension composite. Priors from OCHA/ACAPS. Live signals from USGS/IPC/WHO/UNHCR/Open-Meteo adjust dimensions. Regional spillover applied. See score_audit on each country.",
      },
